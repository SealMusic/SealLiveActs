...
def main_list(params):
	...
	plugintools.add_item(title = "", url = base + "", thumbnail = icon05, fanart = fan01, folder = False)
	plugintools.add_item(title = "", url = base + "", thumbnail = icon06, fanart = fan01, folder = False)	
